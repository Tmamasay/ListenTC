<template>
  ...
  <div class="setCont">
    ...
    <div class="setContP" style="margin-top:10px">
      <div class="setLine" style="border-bottom: 1px solid #EFEDEE;" @click="gotoAboutUs">
        <p class="setL">关于我们</p>
        <div class="setRGo">
          <!-- <p class="setR">18883630318</p> -->
          <i-icon type="enter" size="17" color="#BBB8B9" />
    ...
    <div class="setContP">
      <div class="setLine" @click="gotoAgreement">
        <p class="setL">隐私协议</p>
        <div class="setRGo">
          <!-- <p class="setR">18883630318</p> -->
          <i-icon type="enter" size="17" color="#BBB8B9" />
...
export default {
  ...
  methods: {
    ...
    gotoAboutUs() {
        wx.navigateTo({
          url: `/pages/index/setUp/about/main` //注意switchTab只能跳转到带有tab的页面，不能跳转到不带tab的页面
        });
    },
    gotoAgreement(){
        wx.navigateTo({
          url: `/pages/index/setUp/agreement/main` //注意switchTab只能跳转到带有tab的页面，不能跳转到不带tab的页面
        });
    }
  },
  onShow() {},
