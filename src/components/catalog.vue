...
<template>
  <div class="courseCatalog">
    <div class="courseCatCont" v-for="(item,index) in catalogList" :key="index">
      ...
      <div
        v-show="item.id==signOpen"
        class="courseCatChild"
        v-for="(child,i) in item.childItemList"
        :key="i"
      >
        ...
        <div class="CatChildRight">
          <div v-if="isbuy==0">
            <img
              v-if="child.isListen=='0'"
              src="../../static/images/index/unplay.png"
              alt
              srcset
              @tap="shikan(0,child.id)"
            />
...
export default {
  ...
  data() {
    return {
      evalCont:
        "这个消防工程师《消防安全综合能力》精讲班+冲刺班非常好，非常棒，好评哟！",
      signOpen: "",
      isCZ: []
    };
  },
